...
$ses_id		=	session_id();
$billNo		=	mysql_query("select bill_no from tbl_bills where bill_no != 0 order by bill_no DESC") or die(mysql_error());
...
if(isset($_POST['submit'])){
	...
	$insert		=	mysql_query("insert into tbl_bills set bill_no='$b_no', item_name='$item_name', item_type='$item_type', qty='$qty', bonus='$bonus', tp='$tp', up='$up', discount='$discount', total_bill='$total_amount', purchase=1 ") or die(mysql_error());
		
		}
		
		if($insert){
			
			$insert_no	=	mysql_query("insert into tbl_bills_no set bill_no='$b_no', date_search='$date_search', date_show='$c_date',  total_bill='$total_bill', dname='$dname', uname='$user_name', purchase=1 ") or die(mysql_query());
			
			}
		
		if($insert){
			$delete		=	mysql_query("delete from tbl_tmp_bill where ses_id='$ses_id' && purchase=1") or die(mysql_error());
                        ...
                        <div class="tblSet">
                         <div id="printable">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" >
                                ...
                                <?php
								$bil_qry	=	mysql_query("select * from  tbl_tmp_bill where purchase=1") or die(mysql_error());
                           ...
                           <div class="btnSection">
                              ...
                              <a style="color:white;" href="plist.php" class="btn" tabindex="15">Go Back</a>
                           </div>  <!--btnSection  -->
