 ...
 <!-- From, to search Start -->    
   ...
   <!--     <form method="get" enctype="multipart/form-data" action="">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 text-right">
           	 ...
           	 <span class="btn back"><a href="sale_report.php"><i class="fa fa-arrow-left"></i>Back</a></span>
            </div>
        </div> <!-- headingSection -->
		...
		if(isset($_POST['srch'])){
			...
			$too	=	$_REQUEST['secondinput'];
			 ...
			 $qryy	=	mysql_query("select * from tbl_bills_no where date_search >=  '$from' && sale = 1 AND date_search <= '$too' && sale=1") or die(mysql_error());
		...
		$get_profit  += $kk['profit'];}
		  ...
		  $qry	=	mysql_query("select * from tbl_bills_no where date_search >= '$from' && sale = 1 AND date_search <= '$too' && sale=1 ") or die(mysql_error());
