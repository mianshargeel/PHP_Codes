 ...
 <!-- Center =============================================================================================== -->
    ...
    <div class="container">
       ...
       <div class="wbox mytable">
       		<form method="post" action="searchp.php"  name="sampleform">
     ...
     <a href="javascript:showCal('Calendar2')">
      <input type="text" style="width:40%; float:left; margin-left:1%;" class="form-control" name="secondinput" placeholder="to" />
		...
		if(isset($_GET['submit'])){
		 ...
		 $qryy	=	mysql_query("select * from tbl_bills_no where date_search like '%$search' && purchase = 1 ") or die(mysql_error());
		...
		$tt_mount += $kk['total_bill']; }
		  ...
		  $qry	=	mysql_query("select * from tbl_bills_no where date_search like '%$search' && purchase = 1 ") or die(mysql_error());
          ...
          <a style="color:#fff;" href="dell_report.php?prid=<?= $data['bill_no'] ?>">X</a>
          </div>
          ...
          <tr>
            ...
            <th><span class="center">Discount</span></th>
        ...
        <tbody>
		 ...
		 ?>
          <tr>
            ...
            <td data-title="TP"><span class="center"><?php echo $getData['bonus']; ?></span></td>
            <td data-title="Qty"><span class="center"><?php echo $getData['discount']; ?>%</span></td>
